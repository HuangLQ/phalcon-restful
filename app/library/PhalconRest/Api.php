...
class Api extends \PhalconApi\Api
{
    ...
    public function getMatchedCollection()
    {
        ...
        return array_key_exists(
            ...
            $this->collectionsByIdentifier
        ) ? $this->collectionsByIdentifier[$collectionIdentifier] : null;
    }
    ...
    public function getMatchedEndpoint()
    {
        ...
        return array_key_exists(
            $fullIdentifier,
            $this->endpointsByIdentifier
        ) ? $this->endpointsByIdentifier[$fullIdentifier] : null;
    }
}
